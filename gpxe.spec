...
# For bz#680148 - VMs with virtIO NIC can't access the PXE server
...
%changelog
* Mon Feb 28 2011 Luiz Capitulino <lcapitulino@redhat.com> - gpxe-0.9.7-6.3.el6_0.1
- gpxe-virtio-avoid-padding-for-len-64.patch [bz#680148]
- Resolves: bz#680148
